...
export default async function NotificationDropdown() {
	...
	const isNewNotification = notifications.some((notification) => !notification.isSeen);
	...
	threads.forEach((thread) => {
		if (myThreads.threads.some((myThread: Thread) => myThread.threadId === thread.threadId)) {
