                ...
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="flex-grow">
                    <p className="mb-2 sm:mb-4 text-sm sm:text-base">
                      I copied package.json from another project and now want to
                      bump all of the dependencies to their latest versions
                      since this is a fresh project and I don't mind fixing
            ...
            <Card className="mb-4 sm:mb-6">
              <CardContent className="pt-4 sm:pt-6">
                ...
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="flex-grow">
                    <p className="mb-2 sm:mb-4 text-sm sm:text-base">
                      There is an online package.json update tool. The versions
                      can also be selected via a dropdown.
                    </p>
                    <p className="mb-2 sm:mb-4 text-sm sm:text-base">
                      It also updates to the major version, which npm outdated
                      and ncu don't do.
                    </p>
                    <p className="text-sm sm:text-base">
                      Paste the package.json content into the input field and
                      let it parse:
                    </p>
