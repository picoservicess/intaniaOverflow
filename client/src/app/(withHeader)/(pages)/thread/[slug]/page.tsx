...
export default async function ThreadPage({
  ...
  const myThreadIds = mythreadResponse.threads.map(
            ...
            <Card className="p-4 sm:p-6 mb-4 sm:mb-6 max-w-4xl mx-auto">
              ...
              <div className="flex gap-2">
                ...
                <div className="flex items-center text-sm text-gray-600">
                  ...
                  <span>
                    โพสเมื่อ {timeAgo(new Date(threadData.createdAt))}
                  </span>
                  {threadData.createdAt != threadData.updatedAt && (
                    <>
                      <span className="mx-1">·</span>
                      <span>
                        แก้ไขล่าสุด {timeAgo(new Date(threadData.updatedAt))}
                      </span>
                    </>
                  )}
                </div>
