...
// Update user profile
export const updateUserProfile = controllerWrapper(async (req: Request, res: Response) => {
...
// Apply a pin
export const applyPin = controllerWrapper(async (req: Request, res: Response) => {
	const token = validateAuth(req);
	try {
...
// View pinned items
export const viewPinned = controllerWrapper(async (req: Request, res: Response) => {
	const token = validateAuth(req);
	try {
...
// Health check
export const healthCheck = controllerWrapper(async (_req: Request, res: Response) => {
	try {
